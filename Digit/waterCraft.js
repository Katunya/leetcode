/*
    Яндекс.Академия
    Лекция 2
    Задача 7. Игра PitCraft происходит в двумерном мире, который состоит из блоков размером 1х1.
    Над островом прошел сильный дождь, определите сколько блоков было затоплено.
 */
